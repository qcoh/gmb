...
SCENARIO("Testing instructions", "[CPU]") {
	GIVEN("TestCPU, ICPU::Data, TestMMU") {
		...
		WHEN("Calling XOR n") {
			...
			THEN(
			    "a == 0x0f, zeroFlag == false, carryFlag == false, "
		...
		WHEN("Calling AND B") {
			...
			THEN(
			    "a == 0x12, zeroFlag == false, negFlag == false, "
			    "halfFlag == true, carryFlag == false") {
				REQUIRE(data.a == 0x12);
				REQUIRE(data.zeroFlag == false);
				REQUIRE(data.negFlag == false);
				REQUIRE(data.halfFlag == true);
		...
		WHEN("Calling AND D") {
			...
			THEN(
			    "a == 0x67, zeroFlag == false, negFlag == false, "
			    "halfFlag == true, carryFlag == false") {
				REQUIRE(data.a == 0x67);
				REQUIRE(data.zeroFlag == false);
				REQUIRE(data.negFlag == false);
		...
		WHEN("Calling AND (HL)") {
			...
			THEN(
			    "a == 0x60, zeroFlag == false, negFlag == false, "
			    "halfFlag == true, carryFlag == false") {
				REQUIRE(data.a == 0x60);
				REQUIRE(data.zeroFlag == false);
				REQUIRE(data.negFlag == false);
		...
		WHEN("Calling AND n") {
			...
			THEN(
			    "a == 0x07, zeroFlag == false, negFlag == false, "
			    "halfFlag == true, carryFlag == false") {
				REQUIRE(data.a == 0x07);
				REQUIRE(data.zeroFlag == false);
				REQUIRE(data.negFlag == false);
		...
		WHEN("Calling ADD SP, n (1)") {
			...
			THEN(
			    "sp == 0x0010, carryFlag == false, halfFlag == "
			    "true, negFlag == false, zeroFlag == false") {
				REQUIRE(data.sp == 0x0010);
				REQUIRE(data.carryFlag == false);
				REQUIRE(data.halfFlag == true);
				REQUIRE(data.negFlag == false);
				REQUIRE(data.zeroFlag == false);
		...
		WHEN("Calling ADD SP, n (2)") {
			...
			THEN(
			    "sp == 0x0100, carryFlag == true, halfFlag == "
			    "false, negFlag == false, zeroFlag == false") {
				REQUIRE(data.sp == 0x0100);
				REQUIRE(data.carryFlag == true);
				REQUIRE(data.halfFlag == false);
				REQUIRE(data.negFlag == false);
				REQUIRE(data.zeroFlag == false);
		...
		WHEN("Calling ADD SP, n (3)") {
			...
			THEN(
			    "sp == 0x0010, carryFlag == true, halfFlag == "
			    "true, negFlag == false, zeroFlag == false") {
				REQUIRE(data.sp == 0x0100);
				REQUIRE(data.carryFlag == true);
				REQUIRE(data.halfFlag == true);
		...
		WHEN("Calling ADD SP, n (4)") {
			...
			THEN(
			    "sp == 0x1237, carryFlag == false, halfFlag == "
			    "false, negFlag == false, zeroFlag == false") {
				REQUIRE(data.sp == 0x1237);
				REQUIRE(data.carryFlag == false);
				REQUIRE(data.halfFlag == false);
				REQUIRE(data.negFlag == false);
				REQUIRE(data.zeroFlag == false);
		...
		WHEN("Calling LD HL,SP + n (2)") {
			...
			THEN(
			    "hl == 0x0100, carryFlag == true, halfFlag == "
			    "false, negFlag == false, zeroFlag == false") {
				REQUIRE(data.hl == 0x0100);
				REQUIRE(data.carryFlag == true);
				REQUIRE(data.halfFlag == false);
		...
		WHEN("Calling LD HL, SP + n (3)") {
			...
			THEN(
			    "hl == 0x0010, carryFlag == true, halfFlag == "
			    "true, negFlag == false, zeroFlag == false") {
				REQUIRE(data.hl == 0x0100);
				REQUIRE(data.carryFlag == true);
				REQUIRE(data.halfFlag == true);
		...
		WHEN("Calling LD HL, SP + n (4)") {
			...
			THEN(
			    "hl == 0x1237, carryFlag == false, halfFlag == "
			    "false, negFlag == false, zeroFlag == false") {
				REQUIRE(data.hl == 0x1237);
				REQUIRE(data.carryFlag == false);
				REQUIRE(data.halfFlag == false);
				REQUIRE(data.negFlag == false);
				REQUIRE(data.zeroFlag == false);
		...
		WHEN("Calling SBC B") {
			...
			THEN(
			    "a == 0xee, carryFlag == false, halfFlag == false, "
			    "negFlag == true, zeroFlag == false") {
				REQUIRE(data.a == 0xee);
				REQUIRE(data.carryFlag == false);
				REQUIRE(data.halfFlag == false);
		...
		WHEN("Calling SBC C") {
			...
			THEN(
			    "a == 0xef, carryFlag == false, halfFlag == true, "
			    "negFlag == true, zeroFlag == false") {
				REQUIRE(data.a == 0xef);
				REQUIRE(data.carryFlag == false);
				REQUIRE(data.halfFlag == true);
		...
		WHEN("Calling SBC E") {
			...
			THEN(
			    "a == 0xff, carryFlag == true, halfFlag == true, "
			    "negFlag == true, zeroFlag == false") {
				REQUIRE(data.a == 0xff);
				REQUIRE(data.carryFlag == true);
				REQUIRE(data.halfFlag == true);
		...
		WHEN("Calling SBC n") {
			...
			THEN(
			    "a == 0x4f, carryFlag == false, halfFlag == true, "
			    "negFlag == true, zeroFlag == false") {
				REQUIRE(data.a == 0x4f);
				REQUIRE(data.carryFlag == false);
				REQUIRE(data.halfFlag == true);
		...
		WHEN("Calling SCF") {
			...
			THEN(
			    "carryFlag == true, halfFlag == false, negFlag == "
			    "false, zeroFlag == true") {
				REQUIRE(data.carryFlag == true);
				REQUIRE(data.zeroFlag == true);
				REQUIRE(data.negFlag == false);
